...
echo "<div class='row mt-2 gy-0' id='content-telefone'>";

    echo '<div class="col-12 align-self-end mt-5" id="button-telefone">';
    echo '<button type="button" onclick="insertTel();" class="btn btn-primary rounded-pill fw-bold px-5">Adicionar</button>';
    echo'</div>';
